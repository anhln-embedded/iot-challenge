...
#define LV_MEM_CUSTOM 1 //0 //Memory-usage monitor OSD only works with this enabled
#if LV_MEM_CUSTOM == 0
    /*Size of the memory available for `lv_mem_alloc()` in bytes (>= 2kB)*/
    #define LV_MEM_SIZE (64 * 1024U * 1024U)  //(128 * 1024U)          /*[bytes]*/
 ...
 *0: to disable caching*/
#define LV_IMG_CACHE_DEF_SIZE   256 //8
...
#define LV_DISP_ROT_MAX_BUF (1000*1024) //(32*1024)
...
#define LV_USE_DEMO_WIDGETS        0 //1
